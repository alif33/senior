...
const silver_information_page:NextPage = () => {
  const allpost = [
    {
      id: 1,
      img: "./img/drawable-hdpi/img_08.png",
      title: "봄이 아름다운 섬, 청산도",
    ...
    {
      id: 2,
      img: "./img/drawable-hdpi/img_09.png",
      title: "봄이 아름다운 섬, 청산도",
      description: `청산도는 우리나라 최초의 슬로시티로 지정된 고장으로 
          아름다운 바다와 옛 섬문화를 고스란히 간직하고 있...`,
    },
    {
      id: 3,
      img: "./img/drawable-hdpi/img_10.png",
      title: "봄이 아름다운 섬, 청산도",
      description: `청산도는 우리나라 최초의 슬로시티로 지정된 고장으로 
          아름다운 바다와 옛 섬문화를 고스란히 간직하고 있...`,
    },
...
export default silver_information_page;